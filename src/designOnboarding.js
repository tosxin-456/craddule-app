        ...
        <>
            {page === 1 && (
                <div className="flex w-full h-screen bg-[#193FAE]">
                    ...
                    <div className="absolute bottom-10 right-10">
                        <button onClick={handleNext} className="bg-[white] text-black py-1 px-5 rounded-2xl">
                            Next
                        </button>
                    </div>
                    ...
                    <div className="absolute bottom-5 left-1/2 transform -translate-x-1/2 flex gap-2">
                        <div className={page === 1 ? 'w-[45px] h-[15px] rounded-2xl bg-[#333333]' : 'w-[30px] rounded-2xl h-[15px] bg-[#D9D9D9]'}></div>
                        <div className={page === 2 ? 'w-[45px] rounded-2xl h-[15px] bg-[#333333]' : 'w-[30px] rounded-2xl h-[15px] bg-[#D9D9D9]'}></div>
                    </div>
                </div>
            )}
            ...
            {page === 2 && (
                <div className="flex w-full h-screen bg-[#193FAE]">
                    ...
                    {/* Next Button at the bottom right */}
                    <div className="absolute bottom-10 right-10">
                        <button onClick={handleNextClick} className="bg-[white] text-black py-1 px-5 rounded-2xl">
                            Next
                        </button>
                    </div>
                    ...
                    {/* Page Indicator */}
                    <div className="absolute bottom-5 left-1/2 transform -translate-x-1/2 flex gap-2">
                        <div className={page === 1 ? 'w-[45px] rounded-2xl h-[15px] bg-[#333333]' : 'w-[30px] rounded-2xl h-[15px] bg-[#D9D9D9]'}></div>
                        <div className={page === 2 ? 'w-[45px] rounded-2xl h-[15px] bg-[#333333]' : 'w-[30px] rounded-2xl h-[15px] bg-[#D9D9D9]'}></div>
                    </div>
                </div>
            )}
