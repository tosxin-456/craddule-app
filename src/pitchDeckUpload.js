  ...
  return (
    ...
    <div className='container'>
      ...
      <div className="upload-container">
        ...
        { loading &&  <button disabled={true} className='submit-button'><FontAwesomeIcon icon={faCircleNotch} className='fa-spin'/></button>}
                { !loading && <button onClick={handleSubmit} className='submit-button'>Submit</button>}
