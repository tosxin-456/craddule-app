...
const SignInWithGoogle = lazy(() => import('./GoogleSignIn.js'));
          ...
          <div className=' lg:p-10 lg:px-20 p-5 px-12 pt-10 lg:pt-16 lg:pb-20'>
            ...
            <div className=''>
                ...
                <div className='flex justify-between items-center text-[16px] mt-3'>
                  ...
                  <div>
                    <a href='password' className='no-underline'>
                      <span className='text-[#1B45BF] font-semibold'>Forgot password?</span>
                    </a>
                  </div>
                </div>

                <button type="submit" className='btn loginBtn mb-1 ' disabled={loading}>
              ...
              <p className='mt-8 font-medium text-[16px]'>
                Not registered yet?
                <a className='ps-2 no-underline text-[#1B45BF] ' href='/signup'>Create an Account</a>
              </p>
            </div>
          </div>
        </div>
        ...
        <div className='hidden lg:flex items-center bg-[#193FAE] relative'>
          ...
          <div className='w-full text-center'>
            ...
            <p className='text-white text-[16px] w-2/3 mx-auto'>
              We know that your ideas are unique. We provide requisite tailored tools.
            </p>
          </div>
        </div>
