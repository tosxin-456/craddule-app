...
const WhereDidYouHearModal = () => {
    ...
    return (
        <>
            {isVisible && (
                <div className=" random-overlay fixed inset-0 flex items-center justify-center bg-black bg-opacity-50">
                    <div className="random-content bg-white rounded-lg shadow-lg p-6 w-full max-w-md mx-4">
                        ...
                        <h2 className="text-2xl font-semibold text-center mb-4">How Did You Hear About Us?</h2>
