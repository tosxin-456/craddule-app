                ...
                <div className="main-content2">
                    ...
                    <div className='bacWHI'>
                        ...
                        {inputPairs.map((pair, index) => (
                            <div className='columnChart' key={index} style={{ marginBottom: '20px' }}>
                                <div className='flex justify-between'>
                                    {/* First input (Input Name) */}
                                    <div style={{ flex: '1', marginRight: '10px' }}>
                                        <p className='mt-[10px] text-[#B0B0B0] mb-[7px]'>Input Name</p>
                                        <input
                                            className='monthOn1'
                                    ...
                                    <div style={{ flex: '1', marginLeft: '10px' }}>
                                        <p className='mt-[10px] text-[#B0B0B0] mb-[7px]'>Input Value</p>
                                        <input
                                            className='monthOn1'
                        ...
                        {/* Add new input pair */}
                        <img onClick={addNewPair} className='w-[20px] mt-[-10px] ' src={plus} />
