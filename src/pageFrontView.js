...
import DesignLogoModal from './component/designLogoModal'
    ...
    <Menu /> 
        ...
        <div className='centerC'>
          ...
          onClick={() => handleImageClick(API_BASE_URL+`/images/${imageDetails.hubFile}`, imageDetails._id, imageDetails.sequence, imageDetails.imageName)}></img>
            ...
            <DesignLogoModal open={isOpen} onClose={() => setIsOpen(false)}>

          </DesignLogoModal>
          
          <EditDesignModal open={isOpen1} onClose={() => setIsOpen1(false)} id={activeImageId} imageName={activeImageName} sequence={activeImageSequence} type={prototypeType} subtype={prototypeSubtype}>
