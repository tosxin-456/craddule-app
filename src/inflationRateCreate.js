...
function InflationMonthOnMonth ()  {
  ...
  const handleInputChangeName = (event) => {
    ...
    const deleteAllGraphs = async () => {
        ...
        try {
            const response = await fetch(`http://localhost:3001/api/graph/${graphName}`, { method: 'DELETE' });
            if (!response.ok) {
        ...
        <div className='year'>Year {index + 1}</div>
            ...
            <div className='wrapperChart'>
                <div className='row'>
                    ...
                    <div className='col-md-4'>
                        <input className='monthOn1' style={{width:"auto"}} onChange={(e) => handleInputChange(index + 1, 'FEB', e.target.value)} type="number"></input>
                        <p className='monthOn1T'>FEB</p>
                    </div>
                    <div className='col-md-4'>
                        <input className='monthOn1'style={{width:"auto"}}  onChange={(e) => handleInputChange(index + 1, 'MAR', e.target.value)} type="number"></input>
                        <p className='monthOn1T'>MAR</p>
                    </div>
                    <div className='col-md-4'>
                        <input className='monthOn1' style={{width:"auto"}} onChange={(e) => handleInputChange(index + 1, 'APR', e.target.value)} type="number"></input>
                        <p className='monthOn1T'>APR</p>
                    </div>

                    <div className='col-md-4'>
                        <input className='monthOn1' style={{width:"auto"}} onChange={(e) => handleInputChange(index + 1, 'MAY', e.target.value)} type="number"></input>
                        <p className='monthOn1T'>MAY</p>
                    </div>

                    <div className='col-md-4'>
                        <input className='monthOn1' style={{width:"auto"}} onChange={(e) => handleInputChange(index + 1, 'JUN', e.target.value)} type="number"></input>
                        <p className='monthOn1T'>JUN</p>
                    </div>

                    <div className='col-md-4'>
                        <input className='monthOn1' style={{width:"auto"}} onChange={(e) => handleInputChange(index + 1, 'JULY', e.target.value)} type="number"></input>
                        <p className='monthOn1T'>JULY</p>
                    </div>

                    <div className='col-md-4'>
                        <input className='monthOn1' style={{width:"auto"}} onChange={(e) => handleInputChange(index + 1, 'AUG', e.target.value)} type="number"></input>
                        <p className='monthOn1T'>AUG</p>
                    </div>

                    <div className='col-md-4'>
                        <input className='monthOn1' style={{width:"auto"}} onChange={(e) => handleInputChange(index + 1, 'SEP', e.target.value)} type="number"></input>
                        <p className='monthOn1T'>SEP</p>
                    </div>

                    <div className='col-md-4'>
                        <input className='monthOn1' style={{width:"auto"}} onChange={(e) => handleInputChange(index + 1, 'OCT', e.target.value)} type="number"></input>
                        <p className='monthOn1T'>OCT</p>
                    </div>

                    <div className='col-md-4'>
                        <input className='monthOn1' style={{width:"auto"}} onChange={(e) => handleInputChange(index + 1, 'NOV', e.target.value)} type="number"></input>
                        <p className='monthOn1T'>NOV</p>
                    </div>

                    <div className='col-md-4'>
                        <input className='monthOn1' style={{width:"auto"}} onChange={(e) => handleInputChange(index + 1, 'DEC', e.target.value)} type="number"></input>
