...
function PhasePercentage() {
    ...
    return (
        <>
            ...
            {/* Modal Overlay */}
            {isModalOpen && (
                <div className="fixed inset-0 top-32 bg-black bg-opacity-50 z-50 flex items-center justify-center p-4">
                                    ...
                                    return (
                                        ...
                                        >
                                            ...
                                            >
                                                <div className="flex items-center space-x-4">
                                                    <div className="relative">
                                                        ...
                                                        <div className="absolute inset-0 flex items-center justify-center">
                                                            <span className={`text-sm font-semibold ${accessible ? 'text-gray-800' : 'text-gray-500'}`}>
                                                                {percentage}%
                                                            </span>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div>
                                                        <p className={`font-semibold ${accessible ? phase.textColor : 'text-gray-500'}`}>
                                                            {phase.title}
                                                            {!accessible && (
                                                ...
                                                {urls.length > 0 && (
                                                    <div className="flex items-center">
                                                        <span className={`text-sm ${accessible ? 'text-gray-500' : 'text-gray-400'} mr-2`}>Tools</span>
                                                        {isExpanded ?
                                                            <FaChevronUp className={`text-sm ${accessible ? 'text-gray-500' : 'text-gray-400'}`} /> :
                                                            <FaChevronDown className={`text-sm ${accessible ? 'text-gray-500' : 'text-gray-400'}`} />
                                                        }
                                                    </div>
                                                )}
                                            </button>
                                                        ...
                                                        <div className="flex flex-wrap gap-2">
                                                            {urls.map((url, urlIndex) => (
                                                                <button
                                                                    ...
                                                                    onClick={() => accessible ? console.log('Navigate to:', url) : subscriptionFunction()}
                                                                    className={`px-3 py-2 text-white rounded-md transition text-sm flex items-center gap-2
                                                                        ${!accessible
                                                                            ? 'bg-gray-400 hover:bg-gray-500 cursor-pointer'
                                                                            : 'bg-blue-800 hover:bg-blue-900'
                                                                        } focus:outline-none focus:ring-2 focus:ring-offset-2 ${accessible
                                                                            ? 'focus:ring-blue-600'
                                                                            : 'focus:ring-gray-300'
                                                                        }`}
