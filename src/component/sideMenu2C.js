...
const SideMenu2 = () => {
  ...
  const onClickD = () =>
    navigate(
      `/questionBusMain/Commercialization/ExecuteTheMarketingAndRouteToMarketStrategies`
    );
        ...
        <ul>
          ...
          {isDropdownOpenB && !isCollapsedB && (
            <ul className="dropdown">
              ...
              <li
                className="dropDownNew"
                onClick={() => onClickCHPd("BringTheMVPToFullScale")}
              >
                Summary PDF
              </li>
            </ul>
          ...
          {isDropdownOpenE && !isCollapsedE && (
            <ul className="dropdown">
              ...
              <li
                className="dropDownNew"
                onClick={() =>
                  onClickCHPd("ExecuteTheMarketingAndRouteToMarketStrategies")
                }
              >
                Summary PDF
              </li>
