...
const SideMenu2 = () => {
  ...
  const onClickCB = () => navigate(`/questionBusMain/Commercialization/BringTheMVPToFullScale/BringTheMVPToFullScale`);

  const onClickD = () => navigate(`/questionBusMain/Commercialization/ExecuteTheMarketingAndRouteToMarketStrategies/ExecuteTheMarketingAndRouteToMarketStrategies`);
