...
function Model ()  {
     ...
     useEffect(() => {
      ...
      return () => {
         ...
         const prototypeSubtype = "3D Model";
    ...
    <Menu /> 
        ...
        <div className='centerC'>
          ...
          onClick={() => handleImageClick(API_BASE_URL+`/images/${imageDetails.hubFile}`, imageDetails._id, imageDetails.sequence, imageDetails.imageName)}></img>
            ...
            <ModelModal open={isOpen} onClose={() => setIsOpen(false)}>

          </ModelModal>
          <EditModelModal open={isOpen1} onClose={() => setIsOpen1(false)} id={activeImageId} imageName={activeImageName} sequence={activeImageSequence} type={prototypeType} subtype={prototypeSubtype}>
