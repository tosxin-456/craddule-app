...
const [formData, setFormData] = useState({
  ...
  const handleImageUpload = (e) => {
    ...
    // Handle the image upload process here (e.g., send it to the server)
  };  
            ...
            <div className='profilePic'>
              ...
              {/* <p className='imgTittle' type='button'>Edit</p>*
                ...
                <ul className={`menu6 ${isDropdownOpen3 ? 'menu-open6' : ''}`}>
                    <li type='button' className='imgItem' onClick={openModal}>Upload a photo</li>
